...
public class DonorDetailsActivity {

    String dName,dMobile,dLoca,dBldgrp,dAge,dLastDate,dWeight,dpass,dEmail;
    int _id;
    public DonorDetailsActivity(int id, String name, String Mobile, String email, String loca, String pass, String bldgrp, String age, String weight, String last)
    {
        _id = id;
        dName = name;
        dMobile = Mobile;
