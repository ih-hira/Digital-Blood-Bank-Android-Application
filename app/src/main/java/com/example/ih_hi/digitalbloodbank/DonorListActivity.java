...
public class DonorListActivity extends Activity {
    ...
    private List<DonorDetailsActivity> donorDetailList;
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(bldGrp.isEmpty() || location.isEmpty())
                    Toast.makeText(DonorListActivity.this,"Fill all field!!!",Toast.LENGTH_SHORT).show();

                else
                {
                    donorDetailList = dbHelper.getSearchedDonorList(bldGrp,location);
                    adapter = new DonorListAdapter(DonorListActivity.this, donorDetailList);
                    donorList.setAdapter(adapter);
                }
            }
        });
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.sms:
                ...
                Intent i = new Intent(DonorListActivity.this,SmsOptions.class);
