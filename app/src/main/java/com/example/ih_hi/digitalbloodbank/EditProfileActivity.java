    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveUpdateInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast msg = Toast.makeText(EditProfileActivity.this,"Please, Fill All The Field !",Toast.LENGTH_SHORT);
                    msg.show();
                }
                else
                {
                    ...
                    Toast msg = Toast.makeText(EditProfileActivity.this,"Update Completed !",Toast.LENGTH_SHORT);
                    msg.show();
                    helper.updateContact(c,userID);
                    Intent i = new Intent(EditProfileActivity.this,DonorProfileActivity.class);
