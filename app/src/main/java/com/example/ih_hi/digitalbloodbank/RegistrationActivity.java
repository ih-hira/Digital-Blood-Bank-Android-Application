...
public class RegistrationActivity extends Activity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getActionBar().setTitle("RegistrationActivity Info.");
        ...
        reg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!password.equals(conPassword))
                {
                    ...
                    Toast msg = Toast.makeText(RegistrationActivity.this,"Password Don't Match !",Toast.LENGTH_SHORT);
                    msg.show();
                }
                        ...
                        ||weight.isEmpty())
                {
                    Toast msg = Toast.makeText(RegistrationActivity.this,"Please, Fill All The Field !",Toast.LENGTH_SHORT);
                    msg.show();
                }
                else
                {
                    ...
                    c.setdWeight(weight);
                    c.setdPass(password);
                    Toast msg = Toast.makeText(RegistrationActivity.this,"Regestration Completed !",Toast.LENGTH_SHORT);
                    msg.show();
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        {
            //Toast msg = Toast.makeText(RegistrationActivity.this,"BLD "+text.getText(),Toast.LENGTH_SHORT);
            //msg.show();
